...
public class Launch extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(button.getName().equals("Ingresar")){
            ...
            //Metodo sql para comprobar usuario en la Base de datos
	    //bd.comprobarExiste(usuario, contraseña,true);
            sesionIniciada();
        }
        if(button.getName().equals("Cerrar Sesion")){
            //metodo sql para actualizar el login
            //bd.actualizarTabla();
            sesionCerrada();
        }
    }
